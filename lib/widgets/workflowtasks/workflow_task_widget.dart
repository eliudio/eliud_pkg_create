  ...
  Widget build(BuildContext context) {
    ...
    return ListView(shrinkWrap: true, physics: ScrollPhysics(), children: [
          ...
          children: [
            ...
            getListTile(
              ...
              title: ComboboxWidget(
                app: widget.app,
                initialValue: widget.model.task!.executeInstantly ? 0 : 1,
                options: const [
                  'No',
                  'Yes',
                ],
      ...
      topicContainer(widget.app, context,
          ...
          collapsed: true,
          children: [
            checkboxListTile(widget.app, context, 'Include',
                widget.model.confirmMessage != null, (value) {
              setState(() {
                if (value!) {
      ...
      topicContainer(widget.app, context,
          ...
          children: [
            checkboxListTile(widget.app, context, 'Include',
                widget.model.rejectMessage != null, (value) {
              setState(() {
                if (value!) {
